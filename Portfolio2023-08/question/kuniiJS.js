  //解答ボタンにid付与しDOMを取得
  let ans401btn = document.getElementById('ans401');
  let ans402btn = document.getElementById('ans402');
  let ans403btn = document.getElementById('ans403');
  let ans404btn = document.getElementById('ans404');
  let ans405btn = document.getElementById('ans405');
